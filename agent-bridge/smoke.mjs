...
const child=spawn(path.join(directory,'occ-native-host.exe'),['chrome-extension://aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/'],{windowsHide:true,shell:false,stdio:['pipe','pipe','pipe']});
