...
- В библиотеку возвращается финальный TXT. Созданные кодом дополнительные файлы пока не возвращаются отдельными вложениями; не удаляйте задание, если хотите изучить их в каталоге jobs.
