...
files=[
 'manifest.json','background.js','artifact-inventory.js','capture-regions.js','content.js','full-page-capture.js','browser-relay.js',
 'agent-console.html','agent-console.css','agent-console.mjs','agent-core.mjs','hermes-controller.mjs',
 'offscreen.html','offscreen.js','viewer.html','viewer.js','viewer.css','library.html','README.md','INSTALL_RU.txt','AGENT_RELAY_RU.md'
]
...
with zipfile.ZipFile(archive) as z:
 ...
 assert 'agent-console.html' in z.namelist() and 'full-page-capture.js' in z.namelist() and 'hermes-controller.mjs' in z.namelist()
